...
void EVE_SUB::_1_1_7()
{
	...
	TO
		セオ.Left();
	セオ.Mes("そういえば君には言ってなかったね");
	TO
		シロ.Mes("へぇ本当だったんだ、よく大丈夫だったね");
	TO
		ファクト.Down();
	セオ.Down();
	セオ.Mes("ええまぁ、なんとか・・・");
...
void EVE_SUB::_1_1_9()
{
	...
	TO
		ファクト.Move(7, 0, 4);
	TO
		ファクト.Mes("今度は職人希望の人だよね？");
	TO
		セオ.Mes("ああ、表の張り紙を見たんだと＠どうだ？");
	TO
		ファクト.Down();
...
void EVE_SUB::_1_1_10()
{
	...
	TO
		セオ.Left();
	セオ.Mes("差別はいかんな＠女の子が武器を作ったっていいじゃないか");
	TO
		セオ.Down();
...
void EVE_SUB::_1_1_11()
{
	...
	TO
		受付.Mes("こんにちは");
	TO
		セオ.Mes("フロンティアスミスのセオです＠鉱山開発課のゴクトさんをお願いします");
	TO
		受付.Mes("少々お待ちください");
	TO
		受付.Move(-3, 0, 4);
...
void EVE_SUB::_1_2_2()
{
	...
	TO
		ファクト.Mes("なんで？");
	TO
		セオ.Mes("原因は分からん＠仕事が減るのはたしかだな");
	TO
		セオ.Mes("人を増やした矢先に困ったもんだ＠武器販売だけだと結構きびしいしな");
	TO
		セオ.E思考();
	TO
		セオ.Mes("ルルファさんが入って、余裕もできたし＠俺は経営や財務に力を入れる");
	TO
		セオ.Mes("お前も何か考えといてくれ");
	TO
		ファクト.Mes("分かった");
