...
void EVE_SUB::_1_2_4()
{
	...
	TO
		スタイト.Mes("良いニュースを知らせに");
	TO
		セオ.Mes("良いニュースですか？");
	TO
		スタイト.Mes("おたくが納品したつるはしなんだが＠評判が良くてね、また受注する事になった");
	TO
		スタイト.Mes("引き受けてくれるか？");
	TO
		セオ.Mes("もちろんです");
...
void EVE_SUB::_1_3_1()
{
	...
	トウツグ.Move(7, 0);
	TO
		ファクト.Mes("セオちょっといい＠工房の件で話があるんだけど");
	TO
		セオ.E疑問();
	TO
		セオ.Mes("何だ？");
	...
	TO
		セオ.E思考();
	TO
		セオ.Mes("しかしなぁ、実際に客が増えるのは先だろ？＠頑張ってなんとかしてくれ");
	TO
		トウツグ.E怒り();
	TO
		トウツグ.Mes("今の設備じゃ駄目なんですよ");
	TO
		トウツグ.Mes("炉は小さくて扱える金属が少ないし＠金床も強度が足りてない");
	TO
		トウツグ.Mes("あんなんじゃナマクラしか作れませんよ＠それでも武器屋の社長ですか？");
	TO
		ファクト.E呆れ();
	TO
		ファクト.Up();
	ファクト.Mes("もうちょっと言葉を選ばないと・・・");
	TO
		トウツグ.Down();
	トウツグ.Mes("何でですか？");
	TO
		セオ.Mes("ファクト！お前どういう指導してるんだ");
	TO
		ファクト.E呆れ();
	TO
		ファクト.Mes("えっ、僕！？");
...
void EVE_SUB::_1_3_2()
{
	...
	TO
		ニット.Mes("おすすめの剣とかありますか？");
	TO
		セオ.E思考();
	TO
		セオ.Mes("そうですね・・・鉄の剣がおすすめです＠切れ味も耐久もよくて、使いやすいですし");
	TO
		ニット.E思考();
	TO
	...
	TO
		ルルファ.Mes("どうしてここに？");
	TO
		レイブル.Mes("姉ちゃんが働いてるって聞いて、せっかくだし武器を買いにな");
	TO
		ルルファ.Mes("仕事はどうしたの？");
	TO
		レイブル.Mes("前の仕事は辞めた＠今日からは俺達の仕事はハンターだ");
	TO
		レイブル.E音符();
	TO
