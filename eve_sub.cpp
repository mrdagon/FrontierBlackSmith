...
void EVE_SUB::_1_7_2()
{
	START
		...
		//ハルファド  おほん
	    //ハルファド　入植開始から５年
	    //ハルファド　フロンティアは何も無い荒れ果てた場所でした
		//ハルファド　物資は不足し、魔獣の襲来に怯える日々が続き
		//ハルファド　その過程、悲しい事に多くの犠牲が生まれました
		//ハルファド  ･･･
		//ハルファド　彼らの尊い犠牲と我々の努力によりフロンティアはここまで発展する事が出来ました
	    //ハルファド　これからもフロンティアの発展を目指し頑張ります！
	    //ハルファド　･･･
	    //ハルファド　今日は仕事は忘れて思い切り楽しみましょう！
		//
		//場面転換
	END
}
