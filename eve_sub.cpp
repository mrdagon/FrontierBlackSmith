...
void EVE_SUB::導入_シナリオ()
{
	...
	TO
		語り部.Emo(EM::音符);
	TO
		語り部.Mes("冥王と聖王の死により、血で血を洗った戦乱の時代は幕を閉じる");
	TO
		語り部.Mes("王の死後、民の中より再び王が現れる");
	TO
		語り部.Mes("王は戦の法は知らなかったが、民を操る術に長ける");
	TO
		語り部.Mes("法は変化し、武が力であった時代は終え平和が訪れる");
	TO
		語り部.Mes("かつて、戦う力無き民は奴隷であった");
	TO
		語り部.Mes("そして、富み無き民はこの時代においても奴隷となる");
	TO
		語り部.Emo(EM::思考);
	TO
		語り部.Mes("物語の舞台は大陸東部フロンティア");
	TO
		語り部.Mes("南部及び西部を支配下に収めた政府は東部開拓に着手する");
	TO
		語り部.Mes("しかし開拓は一年目にして頓挫する");
	TO
		語り部.Mes("手付かずであった東部地方は独自の生態系を有しており＠他の地域には見られない魔獣が存在していた");
	TO
		語り部.Mes("魔獣は自らのテリトリーを犯す人間を喰らい、町を襲った");
	TO
		語り部.Mes("多くの開拓者が犠牲になりながらも、開拓は遅々として進まず＠時間だけが過ぎていく");
	TO
		語り部.Mes("しかし、ある者により魔獣を資源として活用する方法を発見される");
	TO
		語り部.Mes("さらに、中央地方では魔獣の毛皮や角、牙、剥製等の収集が流行りだす");
	TO
		語り部.Mes("恐ろしい魔獣の牙は金と同等、煌く竜の瞳は宝石以上の価値を持つ");
	TO
		語り部.Mes("人々は大金を得るため、武器を手に東部フロンティアへ旅立つ");
	TO
...
void EVE_SUB::つるはし製造開始()
{
	...
	TO
		...
		act[1].E思考();
	TO
		セオ.Mes("それはそれとして明後日、担当者が視察に来るそうだ");
	TO
	...
	TO
		セオ.Mes("竜の件でハンターが増えるのも、もう少し先だ＠それまでに店が潰れちゃ困る");
	TO
