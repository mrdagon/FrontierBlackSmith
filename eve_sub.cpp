...
void EVE_SUB::_1_5_3()
{
	...
	TO
		ルルファ.Mes("フロンティア在住のトージョー氏が＠ゼラルーに生息する魔獣から＠特殊な油を精製する事に成功した");
	TO
		ルルファ.Mes("ゼラルーはフロンティアに生息する魔獣で＠ゼラチン質の体を持つ");
	TO
		ルルファ.Mes("ゼラルー油は動物油や植物油に比べ＠高いエネルギーを持つ");
	TO
		ルルファ.Mes("ゼラルーは大量に生息しているため＠安価に油が精製されるようになるだろう");
	TO
		ルルファ.Mes("この発表で、燃料油関連株は大幅に値動きしている");
	TO
		ルルファ.E疑問();
	TO
	...
	TO
		ルルファ.E音符();
	TO
		ルルファ.Mes("あっ！燃料費が減りますね");
	TO
		セオ.E呆れ();
	TO
		セオ.Mes("まぁ、それもそうなんだが");
	TO
		セオ.Mes("ゼラルーを狩るハンターが増える方が大事かな");
	TO
		セオ.Mes("客も増えるだろうし、忙しくなる＠がんばろうな");
	TO
		ルルファ.Mes("はい！");
	END
}
