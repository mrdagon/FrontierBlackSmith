...
void EVE_SUB::_1_3_2()
{
	...
	TO
		ニット.Mes("魔獣狩りって言っても近場でゼラルーを狩るだけなら＠対して危険じゃないよ");
	TO
		ルルファ.E思考();
	TO
		ルルファ.Mes("兄さんがそう言うなら・・・");
	...
	ニット.Up();
	レイブル.Up();
	セオ.Mes("心配するのも分かりますが＠うちの武器を使えば、魔獣なんてたいした事ないですよ");
	TO
		ルルファ.Mes("そう、ですね・・・");
	END
}
...
void EVE_SUB::_1_4_1()
{
	...
	TO
		セオ.Mes("しかしながら、他の店がオープンすると言う情報も入っています");
	TO
